...
Khi ứng dụng chạy lần đầu, hệ thống tự nạp role, tài khoản mẫu, hồ sơ bé mẫu và nội dung học tập mặc định nếu dữ liệu còn thiếu.
...
- Đăng nhập phụ huynh mẫu và xem được báo cáo.
- Đăng nhập admin mẫu và xem được kho nội dung.
- Bài học mẫu đang ở trạng thái `published`.
...
- Không lưu mật khẩu hash bằng SQL seed. Tài khoản mẫu được tạo qua ASP.NET Identity để đúng chuẩn bảo mật.
